...
export default function cleanPlayerName(raw: string): string {
    ...
    raw = _.trim(raw)
        ...
        .replaceAll(/^AGukesh D$/g, "Gukesh D")
        ...
        .replaceAll(/^Hooded Gentleman$/g, "Mr Hoodie Guy")
        ...
        .replaceAll(/^Tigran Petrosian$/g, "Tigran Vartanovich Petrosian")
        .replaceAll(/^Tigran L Petrosian$/g, "Tigran L. Petrosian")
