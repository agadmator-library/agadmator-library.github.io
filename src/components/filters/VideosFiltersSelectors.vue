...
import SacrificeFilterSelector from "@/components/filters/SacrificeFilterSelector.vue";
...
function onReplaceFilter(event: ReplaceVideoFilterEvent) {
  ...
  if (idx >= 0) {
    filters.value[idx] = event.replacementStrategy.replace(
      filters.value[idx],
      event.videoFilter
    );
  } else {
...
<template>
  <div class="card mt-2">
    <div class="card-header">
      Filters
      <button
        class="btn btn-light float-end p-0"
        type="button"
    ...
    >
      <div class="card">
        <div
          class="card-header"
          data-bs-toggle="collapse"
          href="#playerFiltersCard"
          aria-expanded="false"
          aria-controls="playerFiltersCard"
        >
          Player filters
          ...
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button
                ...
                id="nav-single-player-tab"
                data-bs-toggle="tab"
                data-bs-target="#nav-single-player"
                type="button"
                role="tab"
      ...
      <div class="card mt-2">
        <div
          class="card-header"
          data-bs-toggle="collapse"
          href="#videoFiltersCard"
          aria-expanded="false"
          aria-controls="videoFiltersCard"
        >
          Video filters
          <button class="btn btn-light float-end p-0" type="button">
            &#x21D5;
        ...
        <div class="card-body collapse" id="videoFiltersCard">
          <form class="row align-items-center" action="" id="videoFiltersForm">
            ...
            <div class="row mt-2">
              <div class="col-auto">
                <AtLeastOneGameFilterSelector
                  @addFilter="onAddFilter"
                  @removeFilter="onRemoveFilter"
                ></AtLeastOneGameFilterSelector>
              </div>
              <div class="col-auto">
                <MultipleGamesFilterSelector
                  @addFilter="onAddFilter"
                  @removeFilter="onRemoveFilter"
                ></MultipleGamesFilterSelector>
              </div>
      ...
      <div class="card mt-2">
        <div
          class="card-header"
          data-bs-toggle="collapse"
          href="#gameFiltersCard"
          aria-expanded="false"
          aria-controls="gameFiltersCard"
        >
          Game filters
          <button class="btn btn-light float-end p-0" type="button">
            &#x21D5;
        ...
        <div class="card-body collapse" id="gameFiltersCard">
          <form
            ...
            action=""
            id="playerNamesFilterForm"
          >
            <div class="row">
              <div class="col">
                <GameOpeningFilterSelector
                  @replaceFilter="onReplaceFilter"
                ></GameOpeningFilterSelector>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col">
                <GameResultFilterSelector
                  @addFilter="onAddFilter"
                  @removeFilter="onRemoveFilter"
                ></GameResultFilterSelector>
              </div>
              <div class="col">
                <SacrificeFilterSelector
                  @addFilter="onAddFilter"
                  @replaceFilter="onReplaceFilter"
                  @removeFilter="onRemoveFilter"
                ></SacrificeFilterSelector>
            ...
            <div class="row mt-2">
              <div class="col">
                <div class="input-group">
                  <MovesFromFilterSelector
                    @replaceFilter="onReplaceFilter"
                    @removeFilter="onRemoveFilter"
                  ></MovesFromFilterSelector>
                  <span class="input-group-text d-none d-lg-block">-</span>
                  <MovesToFilterSelector
                    @replaceFilter="onReplaceFilter"
                    @removeFilter="onRemoveFilter"
                  ></MovesToFilterSelector>
                </div>
              ...
              <div class="col mt-2 mt-lg-0">
                <div class="input-group">
                  <GameYearFromFilterSelector
                    @replaceFilter="onReplaceFilter"
                    @removeFilter="onRemoveFilter"
                  ></GameYearFromFilterSelector>
                  <span class="input-group-text d-none d-lg-block">-</span>
                  <GameYearToFilterSelector
                    @replaceFilter="onReplaceFilter"
                    @removeFilter="onRemoveFilter"
                  ></GameYearToFilterSelector>
                </div>
